...
import { createDeepSeekBackend, createExaBackend, SubscriptionChainSearchProvider } from './chain-search.js'
import { DEFAULT_SETTINGS, SearchChain, SearchChainError, SEARCH_CHAIN_PROTOCOL } from './search-chain.js'

export { createDeepSeekBackend, createExaBackend, SubscriptionChainSearchProvider } from './chain-search.js'
...
export const Config = z.object({
  ...
  enabled: z.dict(z.boolean()).default({ chatgpt: true, grok: true, exa: true, deepseek: true }),
  order: z.array(z.string()).default(['chatgpt', 'grok', 'exa', 'deepseek']),
