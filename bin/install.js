...
const DEFAULT_SOURCE = 'github:shaomingbo/dsh-subscription-search#v0.1.1'
...
async function main() {
  ...
  if (options.help) {
    console.log(`Usage: ${PACKAGE_NAME} [--profile web] [--source github:shaomingbo/dsh-subscription-search#v0.1.1]\n\nInstalls the package into a DSH profile and adds its Cordis bundle.`)
    return
  }
